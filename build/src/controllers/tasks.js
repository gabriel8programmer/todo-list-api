...
_a = TasksController;
TasksController.all = async (req, res, next) => {
    try {
...
TasksController.show = async (req, res, next) => {
    try {
...
TasksController.save = async (req, res, next) => {
    try {
        const { id } = req.params;
...
TasksController.delete = async (req, res, next) => {
    try {
        const { id, taskId } = req.params;
        const task = await tasks_1.TasksModel.findById(taskId);
        if (!task)
...
TasksController.deleteAll = async (req, res, next) => {
    try {
        const { id } = req.params;
